...
COPY --from=builder grin/core/fuzz/target/x86_64-unknown-linux-gnu/release/compact_block_read_v2 /
COPY --from=builder grin/core/fuzz/target/x86_64-unknown-linux-gnu/release/transaction_read_v1 /
COPY --from=builder grin/core/fuzz/target/x86_64-unknown-linux-gnu/release/transaction_read_v2 /